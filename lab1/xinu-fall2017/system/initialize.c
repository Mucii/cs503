...
pri16   psprio;        		/* Currently priotity of group PS       */
pri16   tsprio;         	/* Currently priotity of group TS       */
pri16   psprioin;       	/* Initial priotity of group PS         */
pri16   tsprioin;       	/* Initial priotity of group TS         */
...
static	void	sysinit()
{
	...
	psprioin=10;       /* Initial priotity of group PS         */
	tsprioin=10;       /* Initial priotity of group TS         */

	psprio=psprioin;         /* Currently priotity of group PS       */
	tsprio=tsprioin;         /* Currently priotity of group TS       */
	...
	/* Initialize the NULL process PS properties */

	prptr->pspi=0;
	prptr->psrate=1;
	prptr->psblock=BLOCKED;

	/* Initialize the NUll process TS properties*/

	prptr->tsnew=TSSECOND;
